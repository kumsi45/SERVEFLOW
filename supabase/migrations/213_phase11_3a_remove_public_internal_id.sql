-- Phase 11.3A security correction: do not expose the internal tenant UUID.
...
begin
  ...
  return jsonb_build_object(
    'business_name', target_restaurant.name, 'payment_policy', target_restaurant.payment_policy,

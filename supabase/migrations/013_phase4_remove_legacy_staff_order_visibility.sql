-- SERVEFLOW Phase 4 staff dashboard overlap correction.
-- Staff dashboard order visibility should be controlled by restaurant_staff,
-- not legacy public.users tenant roles. Customers still see their own orders.

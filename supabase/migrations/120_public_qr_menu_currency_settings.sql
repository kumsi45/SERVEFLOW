-- Expose public-safe currency settings in public QR menu payload.
...
as $$
  with target_restaurant as (
    select id, name, slug, total_tables, branding, ordering_settings, currency_code, currency_symbol, locale

-- ServeFlow Phase W2.1: waiter dashboard identifier normalization.
-- Keep restaurant identity database-backed and host-neutral. The dashboard RPC
-- accepts the same route identifiers as waiter login, then returns canonical
-- restaurant_slug for all client navigation.

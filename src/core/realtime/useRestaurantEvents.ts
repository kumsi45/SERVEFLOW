...
export function useRestaurantEvents(options: { restaurantId: string; onEvent: (event: RestaurantEvent) => void; client?: SupabaseClient; tables?: readonly string[] }) {
  ...
  }, [client, restaurantId, tableScope]);
  return state;
}

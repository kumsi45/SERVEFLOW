...
const ROLE_SECTIONS: Record<RoleNamespace, readonly string[]> = {
  ...
  inventory: ["dashboard", "items", "current-stock", "movements", "stock-in", "stock-out", "adjustments", "waste", "transfers", "ledger", "movement-history", "categories", "suppliers", "storage-locations", "units"],

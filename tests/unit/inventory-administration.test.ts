...
describe("Phase 8.1 inventory administration contracts", () => {
  ...
  it("routes the complete inventory navigation surface", () => {
    ...
    expect(router).toContain('inventory: ["dashboard", "items", "current-stock", "movements", "stock-in", "stock-out", "adjustments", "waste", "transfers", "ledger", "movement-history", "purchase-orders", "purchase-history", "low-stock-assistant", "categories", "suppliers", "storage-locations", "units"]');

...
const markup = `<main class="kd-root"><header class="kd-header"><div class="kd-header-logo-area"><span class="sf-brand"><span class="sf-brand-mark">S</span><span class="sf-brand-name">ServeFlow</span></span><span class="kd-header-kitchen-context">Kitchen: Beverages</span></div><div class="kd-divider"></div><div class="kd-status-pill">ONLINE</div><div class="kd-header-datetime">Sat · 9:10 AM</div><div class="kd-header-search"><input aria-label="Search orders"></div><div class="kd-active-badge">4 Active</div><div class="kd-header-actions"><div class="kd-material-actions"><div class="kd-stock-requests-control"><button class="kd-stock-requests-trigger" aria-expanded="true">Requests <span>10</span><i>⌄</i></button><button class="kd-stock-panel-backdrop" aria-label="Close stock requests" onclick="document.querySelector('.kd-stock-panel').style.display='none';this.style.display='none'"></button><section class="kd-stock-panel" aria-label="Stock Requests"><header class="kd-stock-panel-header"><div><h2>Stock Requests</h2><p>10 waiting for confirmation</p></div><button aria-label="Close stock requests" onclick="this.closest('.kd-stock-panel').style.display='none'">×</button></header><div class="kd-stock-panel-scroll">${cards}</div><footer class="kd-stock-panel-footer"><button>View request history</button></footer></section></div><button class="kd-signout-btn">Create Request</button></div><button class="kd-icon-btn" aria-label="Notifications">🔔</button><button class="kd-icon-btn" aria-label="Refresh">↻</button><button class="kd-signout-btn">Sign Out</button></div></header><section class="kd-filter-bar"><button class="kd-filter-btn active">All</button><button class="kd-filter-btn">New 2</button><button class="kd-filter-btn">Preparing 1</button></section><section class="kd-order-workspace"><div class="kd-order-grid"><article class="kd-order-card"><header class="kd-card-header"><h2>Order 104</h2></header></article></div></section><div class="kd-toast-stack"><div class="kd-operation-toast" role="status">Stock requests updated.<button>×</button></div></div><div class="kd-receipt-dialog-layer" style="display:none"><section class="kd-receipt-dialog" role="dialog" aria-label="Confirm receipt"><header><h2>Confirm receipt</h2><strong>Sugar · 2 kg</strong></header><p>Confirm that 2 kg of Sugar was received from Main Store.</p><footer><button onclick="this.closest('.kd-receipt-dialog-layer').style.display='none'">Cancel</button><button>Confirm Received</button></footer></section></div></main>`;

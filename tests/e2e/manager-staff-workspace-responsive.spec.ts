  ...
  await page.setContent(`
    ...
    <main class="mso-page"><section class="mso-panel">
      ...
      <div class="mso-data-list mso-directory-list">
        ...
        <button class="mso-directory-row"><span class="mso-staff-identity"><span class="mso-avatar">AM</span><span><strong>Amar</strong><small>KT-00002</small></span></span><span data-label="Role">Chef</span><span data-label="Shift"><span class="mso-not-recorded">Not recorded</span></span><span data-label="Status"><span class="mso-status-pill warning"><span></span>On break</span></span><span data-label="Current work" class="mso-current-work">Beverages</span><span class="mso-chevron">›</span></button>
      </div>
    </section></main>
  `);
